...
func TestActionsIndex(t *testing.T) {
	...
	assert.Len(t, Actions.GetActionNamesForService(BridgeService), len(Actions.GetActionsForAPIs(BridgeService, CommunicationAPI, EventsAPI, KycAPI, ManagementAPI, StatisticAPI, TaskAPI)))
}
