...
//go:generate mockgen --build_flags=--mod=mod -destination=./mock/producer.go -package=mock -mock_names=Producer=Producer github.com/cloudtrust/common-service/v2/events Producer
