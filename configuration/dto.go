...
type RealmAdminConfiguration struct {
	...
	AutogeneratedUsernameEnabled          *bool           `json:"autogenerated_username_enabled"`
	AutogeneratedUsernameToggleEnabled    *bool           `json:"autogenerated_username_toggle_enabled"`
}
