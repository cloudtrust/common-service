...
var (
	...
	IDPGetIdentityProviderMapper    = Actions.addAction(BridgeService, IdpAPI, "IDP_GetIdentityProviderMappers", ScopeRealm)
	IDPCreateIdentityProviderMapper = Actions.addAction(BridgeService, IdpAPI, "IDP_CreateIdentityProviderMapper", ScopeRealm)
	IDPUpdateIdentityProviderMapper = Actions.addAction(BridgeService, IdpAPI, "IDP_UpdateIdentityProviderMapper", ScopeRealm)
	IDPDeleteIdentityProviderMapper = Actions.addAction(BridgeService, IdpAPI, "IDP_DeleteIdentityProviderMapper", ScopeRealm)
)
